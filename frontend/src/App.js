...
import { LoginModal, UserCard, getAllTasks, addTask, removeTask, updateTaskStatus } from './Components'
import "./App.css";
...
function App() {
  ...
  async function handleDeleteTask(userId, taskId) {
    ...
    newUserData[userId].tasks = newUserData[userId].tasks
  ...
  return (
    <div className="App">
      ...
      <LoginModal signedInUser={signedInUser} setSignedInUser={setSignedInUser} setUserDisplayName={setUserDisplayName} />
    </div>
  );
}
