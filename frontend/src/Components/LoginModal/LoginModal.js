...
export function LoginModal({
  ...
  async function createUser() {
    ...
    await axios
      .put("http://localhost:3001/user/create", reqBody)
      .then((res) => {
    ...
    <Dialog open={signedInUser === null}>
      {addUserModal ? (
        <div className="modal-content">
          ...
          <DialogContent>
            I decided to not make this super secure since it's just a task list
            app. so only a username will be required to login.
